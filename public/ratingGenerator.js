...
export const generateRatings = async (createOrUpdateCubeWithScene) => {
    try {
        ...
        if (!['text-davinci-003', 'gpt-3.5-turbo-instruct', 'gpt-3.5-turbo', 'gpt-4', 'gpt-4-1106-preview', 'gpt-4-0125-preview', 'gpt-4-turbo-preview', 'gemini-pro','mistral-medium', 'mistral-large', 'claude-v2', 'claude-v3'].includes(model)) {
